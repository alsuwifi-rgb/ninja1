    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-ownerMaintenances">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.maintenance.fields.asset') }}
                            </th>
                            <th>
                                {{ trans('cruds.maintenance.fields.owner') }}
                            </th>
                            <th>
                                {{ trans('cruds.maintenance.fields.spent') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-ownerMaintenances:not(.ajaxTable)').DataTable({ buttons: dtButtons })
