    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-ownerContactCompanies">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.contactCompany.fields.owner') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-ownerContactCompanies:not(.ajaxTable)').DataTable({ buttons: dtButtons })
