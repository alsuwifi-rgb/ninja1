    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userRestaurants">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.restaurant.fields.contact_name') }}
                            </th>
                            <th>
                                {{ trans('cruds.restaurant.fields.mobile') }}
                            </th>
                            <th>
                                {{ trans('cruds.restaurant.fields.user') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-userRestaurants:not(.ajaxTable)').DataTable({ buttons: dtButtons })
