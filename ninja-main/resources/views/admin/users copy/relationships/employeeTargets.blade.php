    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-employeeTargets">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.target.fields.employee') }}
                            </th>
                            <th>
                                {{ trans('cruds.target.fields.year') }}
                            </th>
                            <th>
                                {{ trans('cruds.target.fields.month') }}
                            </th>
                            <th>
                                {{ trans('cruds.target.fields.monthly_target') }}
                            </th>
                            <th>
                                {{ trans('cruds.target.fields.monthly_bonus') }}
                            </th>
                            <th>
                                {{ trans('cruds.target.fields.m_t_commission') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($targets as $key => $target)
                            <tr data-entry-id="{{ $target->id }}">
                                ...
                                <td>
                                    {{ $target->monthly_bonus ?? '' }}
                                </td>
                                <td>
                                    {{ $target->m_t_commission ?? '' }}
                                </td>
                                <td>
                                    @can('target_show')
...
@endcan
  ...
  let table = $('.datatable-employeeTargets:not(.ajaxTable)').DataTable({ buttons: dtButtons })
