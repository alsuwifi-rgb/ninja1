...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-success-gradient navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" style="color: white !important;"><i class="fa fa-bars"></i></a>
                </li>
            </ul>
...
{{--            @if(count(config('panel.available_languages', [])) > 1)--}}
                <ul class="navbar-nav ml-auto">
                    <li>
                        <select class="searchable-field form-control" style="min-width: 300px;">
...
{{--            @endif--}}
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown notifications-menu">
                    <a href="#" class="nav-link" data-toggle="dropdown" style="color: white !important;">
